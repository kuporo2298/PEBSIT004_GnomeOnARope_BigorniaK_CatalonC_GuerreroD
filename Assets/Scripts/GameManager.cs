...
public class GameManager : Singleton<GameManager>
{
    ...
    // ---------------------------
    // NEW: Called from MainMenu buttons
    // ---------------------------
    ...
    public void Reset()
    {
        ...
        var resetObjects = UnityEngine.Object.FindObjectsByType<Resettable>(FindObjectsSortMode.None);
;
        foreach (Resettable resettable in resetObjects)
            resettable.Reset();
